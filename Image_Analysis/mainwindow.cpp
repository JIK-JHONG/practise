    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->Slider_screentone_gap->setRange(0, 100);  // 設定範圍：1 到 100
    ui->Slider_screentone_size->setRange(1, 100);  // 設定範圍：5 到 50
    ui->image_threshold->setRange(1, 255);  // 設定範圍：5 到 50
